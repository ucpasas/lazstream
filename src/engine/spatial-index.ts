...
export class SpatialIndex {
  ...
  private fileBBox: BBox3D | null = null
  ...
  /** Full file 3D bbox passed in at build time. */
  getFileBBox(): BBox3D | null {
    return this.fileBBox ? { ...this.fileBBox } : null
  }
  ...
  /** How many entries have been tightened post-decode. Debug stat. */
  tightenedCount(): number {
    let n = 0
    for (const e of this.byIndex.values()) if (e.tight) n++
    return n
  }
